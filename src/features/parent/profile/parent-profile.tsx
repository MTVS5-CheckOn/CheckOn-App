...
export function ParentProfile() {
  ...
  return (
    <div className="space-y-7 px-5 py-4">
      ...
      <ProfileSection title="등록된 자녀"><div className="overflow-hidden rounded-card border border-border bg-surface">{children.map((child) => <div key={child.studentId} className="flex min-h-[72px] items-center gap-3 border-b border-divider px-4">
