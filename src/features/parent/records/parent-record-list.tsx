...
import { parentRecords, type ParentRecord } from "@/features/parent/shared/mock-data";
...
export function ParentRecordList() {
  ...
  const records = useMemo(() => parentRecords.filter((item) => item.month === month && (area === "전체" || item.area === area)), [area, month]);
