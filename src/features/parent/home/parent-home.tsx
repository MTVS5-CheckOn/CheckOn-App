...
import { parentRecords } from "@/features/parent/shared/mock-data";
import { useParentStore, useSelectedChild } from "@/features/parent/shared/parent.store";

export function ParentHome() {
  const { metrics, report } = parentHomeData;
