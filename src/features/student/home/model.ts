...
export const studentHomeData = {
  ...
  today: [
    { id: "l1", area: "문학", status: "신규", title: "현대시 독해 집중훈련", meta: "10문항 · 약 20분" },
    { id: "l2", area: "독서", status: "진행 중", title: "독서 추론·전개 유형", meta: "8문항 · 약 18분" },
  ] satisfies WorksheetSummary[],
  continuing: { id: "l2", area: "독서", status: "진행 중", title: "독서 추론·전개 유형", meta: "3 / 8문항 완료", completed: 3, total: 8 } satisfies WorksheetSummary,
};
